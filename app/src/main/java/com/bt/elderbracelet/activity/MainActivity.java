...
public class MainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!TextUtils.isEmpty(user_id) && !TextUtils.isEmpty(SpHelp.getDeviceMac())) {
            ...
            readyScanDeice();
            initUI();
        } else   //如果Registre表中数据为空，即现在这台设备是陌生的设备，那么先显示设备绑定界面
        //即搜索附近的蓝牙BLE设备
        {
            //绑定设备
    ...
    public void openBluetooth()
    {
        ...
        if (mBluetoothAdapter == null) {   //如果手机支持蓝牙，则直接结束
            finish();
        }
    ...
    public void initServiceAndReceiver()
    {
        ...
        mIntentFilter.addAction(BleService.ACTION_GATT_CONNECTED);            //蓝牙已经连接
        mIntentFilter.addAction(BleService.ACTION_GATT_DISCONNECTED);         //蓝牙连接已经断开
    ...
    BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, final Intent intent)
        {
            ...
            } else if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {//断开报警
            ...
            if (device.getAddress().equals(SpHelp.getDeviceMac())) {
                ...
                if (mScaning) {
                    ...
                    if (mBluetoothLeService != null) {
                        ...
                        System.out.println("连接时 mBluetoothLeService 为null******************");
                    }
                }
            }
        }
