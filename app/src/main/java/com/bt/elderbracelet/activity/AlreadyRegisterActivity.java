...
public class AlreadyRegisterActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.bracelet_already_register);
    ...
    private void init()
    {
        ...
        titleView.setTitle(R.string.already_register);
